...
config :personal_planner, PersonalPlannerWeb.Endpoint,
  ...
  secret_key_base: "MSkgihLbfLwJ3PGwjAc/qNWfi5wAa3EKf2eIiu/qhaFWJGwItqWVNIU/XDazO4x/",
  server: false

# In test we don't send emails.
config :personal_planner, PersonalPlanner.Mailer, adapter: Swoosh.Adapters.Test
